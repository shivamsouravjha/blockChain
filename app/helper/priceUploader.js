...
class PriceUploadHelper {
  async getPlatformApiRequestParams() {
   ...
   let ethPrice =  crossPlatformCall.crossPlatformCall(constants.HTTP.GET,constants.fetchEthPrice.URL,params)
   ethPrice = await axios(ethPrice);
   await Database.saveCurrency(constants.fetchEthPrice.Name,constants.fetchEthPrice.IDS,constants.fetchEthPrice.Currency,ethPrice.data.ethereum.inr)
  };
}
